...
const features = [
  {
    ...
    description: "Create and send prescriptions instantly as PDFs via WhatsApp. No more lost or damaged paper prescriptions.",
    tag: "Core workflow",
  ...
  },
  {
    ...
    description: "Find alternative medicines by the same salt composition when your prescribed brand is unavailable.",
  ...
  },
  {
    ...
    description: "Schedule follow-ups with automatic WhatsApp confirmations. Reduce no-shows with intelligent reminders.",
  ...
  },
  {
    ...
    description: "Access complete patient records and visit history instantly. Make informed decisions every time.",
    tag: "Record quality",
  ...
  },
  {
    ...
    icon: <path strokeLinecap="round" strokeLinejoin="round" d="M11.412 15.655L9.75 21.75l3.745-4.012M9.257 13.5H3.75l2.659-2.849m2.048-2.195L14.25 2.25l-2.25 7.5h5.25l-4.507 4.83" />,
    description: "Cancel a range of appointments with one click in emergencies. Patients are notified automatically.",
  ...
  },
  {
    ...
    icon: <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75c0 .621-.504 1.125-1.125 1.125h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />,
    description: "Track monthly earnings, patient activity, and clinic performance without any extra effort.",
      ...
      <main>
          ...
          <div className="relative mx-auto grid max-w-7xl grid-cols-12 gap-8 px-4 pb-16 sm:px-6 lg:px-8 xl:pb-24">
            <div className="col-span-12 flex flex-col justify-center xl:col-span-6">
              <div className="flex items-center gap-4">
                ...
                <p className="font-mono text-[9px] uppercase tracking-[0.35em] text-[var(--color-text-secondary)] sm:text-[10px]">Premium Clinic Workflow</p>
              </div>

              <h1
                className="mt-8 max-w-[15ch] text-[2.75rem] font-heading font-extrabold leading-[0.9] tracking-[-0.04em] text-balance sm:max-w-3xl sm:text-6xl sm:tracking-tight lg:text-7xl xl:text-[5.5rem]"
              >
                <span className="block">Clinic workflow,</span>
                <span className="block text-[var(--color-primary)]">mastered with</span>
                <span className="block italic text-[var(--color-secondary)]">quiet precision.</span>
              </h1>

              <p className="mt-8 max-w-xl text-[1rem] leading-relaxed text-[var(--color-text-secondary)] sm:text-lg">
                MedAlerto unifies prescriptions, scheduling, and patient history into a single, intuitive interface designed for the modern practice.
              </p>
              ...
              <div className="mt-12 flex items-center gap-8 border-t border-[var(--color-border)]/50 pt-10">
                <div>
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest text-[var(--color-text-secondary)]/60">Active Doctors</p>
                </div>
                <div className="h-8 w-px bg-[var(--color-border)]/50" />
                <div>
                  <p className="text-2xl font-bold text-[var(--color-primary)]">1M+</p>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-[var(--color-text-secondary)]/60">Patients Served</p>
                </div>
              </div>
            </div>
        ...
        <section className="py-24 bg-[var(--color-bg)]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 className="text-4xl font-heading font-semibold mb-16">The operational heart of your clinic.</h2>
              ...
              >
                ...
                <div className="flex-1 flex overflow-hidden bg-[var(--color-bg-soft)]">
                  ...
                  <div className="w-16 bg-[#0D2B3E] border-r border-white/5 p-4 flex flex-col gap-8">
                    {[
                      { icon: <path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />, id: 0 },
                      { icon: <path d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />, id: 1 },
                      { icon: <path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />, id: 2 },
                      { icon: <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />, id: 3 }
                    ].map((item, i) => (
                      <svg 
                        key={i} 
                  ...
                  <div className="flex-1 flex flex-col p-8 overflow-hidden relative">
                    <div className={`transition-all duration-700 absolute inset-0 p-8 flex flex-col ${activeView === 0 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8 pointer-events-none'}`}>
                      {/* Header */}
                      <div className="flex items-center justify-between mb-10">
                        <div className="flex items-center gap-6">
                          <h3 className="text-2xl font-heading font-bold text-[#0D2B3E]">Daily Overview</h3>
                      ...
                      <div className="grid grid-cols-3 gap-6 mb-10">
                        {[
                          ...
                          { label: 'Earnings', value: '$4,820', change: '+$210' }
                        ].map(stat => (
                          <div key={stat.label} className="bg-white rounded-[2rem] p-6 border border-[var(--color-border)]/40 shadow-sm">
                            <p className="text-xs font-bold text-[var(--color-text-secondary)] uppercase tracking-widest mb-2">{stat.label}</p>
                            <div className="flex items-baseline gap-3">
                              <span className="text-3xl font-black text-[#0D2B3E]">{stat.value}</span>
                      ...
                      <div className="flex-1 bg-white rounded-[2rem] border border-[var(--color-border)]/40 shadow-sm p-6 overflow-hidden">
                        <div className="flex items-center justify-between mb-6 border-b border-[var(--color-border)]/30 pb-4">
                          <span className="text-xs font-black text-[#0D2B3E] uppercase tracking-widest">Recent Patients</span>
                          <span className="text-xs font-bold text-[var(--color-primary)]">Full Directory</span>
                        </div>
                        <div className="space-y-5">
                          {[
                            { name: 'Sarah Jenkins', time: '09:30 AM', status: 'In Clinic', color: 'bg-green-100 text-green-700', img: 'https://i.pravatar.cc/150?u=sarah' },
                            { name: 'Michael Ross', time: '10:15 AM', status: 'Scheduled', color: 'bg-blue-100 text-blue-700', img: 'https://i.pravatar.cc/150?u=michael' },
                            { name: 'Emma Wilson', time: '11:00 AM', status: 'Follow up', color: 'bg-purple-100 text-purple-700', img: 'https://i.pravatar.cc/150?u=emma' }
                          ].map(patient => (
                            <div key={patient.name} className="flex items-center justify-between py-3 border-b border-gray-50 last:border-0">
                              <div className="flex items-center gap-5">
                                <img src={patient.img} alt={patient.name} className="h-12 w-12 rounded-full object-cover border border-slate-200" />
                                <div><p className="text-sm font-bold text-[#0D2B3E]">{patient.name}</p><p className="text-xs text-[var(--color-text-secondary)]">{patient.time}</p></div>
                              </div>
                              <span className={`text-[10px] font-black uppercase tracking-wider px-3 py-1.5 rounded-full ${patient.color}`}>{patient.status}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                    ...
                    <div className={`transition-all duration-700 absolute inset-0 p-8 flex flex-col ${activeView === 1 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8 pointer-events-none'}`}>
                      <h3 className="text-2xl font-heading font-bold text-[#0D2B3E] mb-10">Patient Directory</h3>
                      <div className="flex-1 bg-white rounded-[2rem] border border-[var(--color-border)]/40 shadow-sm p-6">
                        <div className="flex items-center justify-between mb-8">
                          <div className="h-12 w-64 bg-slate-50 rounded-xl border border-slate-100 px-4 flex items-center text-sm text-slate-400">Search patients...</div>
                          <div className="h-12 w-32 bg-[var(--color-primary)] rounded-xl flex items-center justify-center text-xs text-white font-bold tracking-wide">Add Patient</div>
                        </div>
                        <div className="space-y-6">
                          {[
                            { name: 'Amna Khan', id: '#P-9281', phone: '+92 301 228811', img: 'https://i.pravatar.cc/150?u=amna' },
                            { name: 'Zeeshan Ahmed', id: '#P-8172', phone: '+92 321 445522', img: 'https://i.pravatar.cc/150?u=zee' },
                            { name: 'Fatima Noor', id: '#P-7721', phone: '+92 333 991100', img: 'https://i.pravatar.cc/150?u=fatima' }
                          ].map((p, i) => (
                            <div key={i} className="flex items-center gap-6 py-4 border-b border-slate-50">
                              <img src={p.img} alt={p.name} className="h-14 w-14 rounded-full object-cover border border-slate-200 shrink-0" />
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-1">
                                  <p className="text-base font-bold text-[#0D2B3E]">{p.name}</p>
                                  <span className="text-[10px] font-bold text-slate-400 uppercase">{p.id}</span>
                                </div>
                                <div className="text-xs text-slate-500">{p.phone}</div>
                              </div>
                              <div className="h-10 w-24 bg-slate-50 rounded-full flex items-center justify-center text-[10px] font-bold text-slate-400 uppercase tracking-widest border border-slate-100">View File</div>
                            </div>
                          ))}
                        </div>
                      </div>
                      ...
                      <div className="flex-1 bg-white rounded-[2rem] border border-[var(--color-border)]/40 shadow-sm p-6 overflow-hidden">
                        <div className="grid grid-cols-7 gap-2 h-full">
                          {Array.from({length: 21}).map((_, i) => (
                            <div key={i} className="border border-slate-50 relative p-2 min-h-[80px]">
                              <span className="text-xs font-bold text-slate-400">{i + 1}</span>
                              {i % 7 === 2 && <div className="absolute inset-x-2 top-8 h-4 bg-blue-100 rounded-md text-[10px] text-blue-700 px-2 flex items-center font-bold">Surgery</div>}
                              {i % 7 === 4 && <div className="absolute inset-x-2 top-8 h-4 bg-green-100 rounded-md text-[10px] text-green-700 px-2 flex items-center font-bold">Review</div>}
                              {i % 7 === 0 && i > 0 && <div className="absolute inset-x-2 top-8 h-4 bg-purple-100 rounded-md text-[10px] text-purple-700 px-2 flex items-center font-bold">Follow-up</div>}
                            </div>
                          ))}
                        </div>
                      </div>
                    ...
                    <div className={`transition-all duration-700 absolute inset-0 p-8 flex flex-col ${activeView === 3 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8 pointer-events-none'}`}>
                      <h3 className="text-2xl font-heading font-bold text-[#0D2B3E] mb-10">Smart Prescriptions</h3>
                      <div className="flex-1 bg-white rounded-[2rem] border border-[var(--color-border)]/40 shadow-sm p-8">
                        <div className="space-y-6">
                          {[
                            { drug: 'Amoxicillin', dose: '500mg, 3x Daily', patient: 'Liam Smith', date: 'Oct 24' },
                            { drug: 'Lisinopril', dose: '10mg, 1x Daily', patient: 'Sarah Jenkins', date: 'Oct 23' },
                            { drug: 'Metformin', dose: '850mg, 2x Daily', patient: 'David Miller', date: 'Oct 23' }
                          ].map((rx, i) => (
                            <div key={i} className="p-6 border border-slate-100 rounded-3xl bg-slate-50/50 flex justify-between items-center">
                              <div>
                                <div className="flex items-center gap-3 mb-2">
                                  <span className="text-base font-bold text-[#0D2B3E]">{rx.drug}</span>
                                  <span className="text-xs font-medium text-slate-500 bg-white px-2 py-0.5 rounded border border-slate-100">{rx.dose}</span>
                                </div>
                                <div className="text-sm text-[var(--color-primary)] font-bold">Patient: {rx.patient}</div>
                              </div>
                              <div className="text-xs font-bold text-slate-400 uppercase tracking-tighter">{rx.date}</div>
                            </div>
                          ))}
                        </div>
                      </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    ...
                    >
                      {isPaused ? (
                        <svg className="h-10 w-10 drop-shadow-md" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
                      ) : (
                        <svg className="h-10 w-10 drop-shadow-md" fill="currentColor" viewBox="0 0 24 24"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z" /></svg>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between">
                    ...
                    >
                      <div className="flex items-center gap-1.5">
                        <div className={`h-2 w-2 rounded-full bg-red-500 ${!isPaused && 'animate-pulse'}`} />
                      ...
                      {!isMuted && !isPaused && (
                        <div className="flex items-center gap-0.5 h-3">
                          {[1,2,3,4].map(i => (
                            <div key={i} className={`w-0.5 bg-[var(--color-primary)] rounded-full animate-bounce`} style={{ animationDelay: `${i * 0.1}s`, height: `${Math.random() * 100}%` }} />
                          ))}
                        </div>
                      )}
                    </div>
                    ...
                    >
                      ...
                      {isMuted ? (
                        <svg className="h-5 w-5 opacity-60 group-hover:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <section id="features" className="border-t border-[var(--color-border)]/60 bg-[var(--color-bg-soft)]/35 py-24 sm:py-28 xl:py-32">
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
              {features.map(({ number, title, description, tag, impact, icon }, index) => (
                <article
                  key={title}
                ...
                >
                  ...
                  <p className="mt-4 flex-1 max-w-md text-sm leading-relaxed text-[var(--color-text-secondary)]">{description}</p>
                  <div className="mt-8 flex items-center justify-between border-t border-[var(--color-border)]/70 pt-6">
                    ...
                    <span className="text-xl text-[var(--color-primary)] font-bold transition-transform duration-300 group-hover:translate-x-1.5">›</span>
                  </div>
                </article>
              ))}
            </div>
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3">
              {testimonials.slice(0, 3).map((item, idx) => (
                <article key={item.author} className="group rounded-4xl border border-[var(--color-border)]/70 bg-[var(--color-card)]/95 p-6 shadow-[0_10px_40px_-10px_rgba(93,112,82,0.12)] transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
                  <div className="mb-6 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] uppercase tracking-wider text-[var(--color-text-secondary)]">{item.role}</p>
                    </div>
                  </div>
                  <p className="text-sm italic leading-relaxed text-[var(--color-text-secondary)]">“{item.quote}”</p>
