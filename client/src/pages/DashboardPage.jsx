...
const upcomingAppointments = [
  { id: 1, name: "Ahmed Raza", time: "09:00 AM", type: "Follow-up", status: "confirmed" },
  { id: 2, name: "Sara Khan", time: "10:30 AM", type: "Consultation", status: "confirmed" },
  { id: 3, name: "Bilal Tariq", time: "11:00 AM", type: "Check-up", status: "pending" },
  { id: 4, name: "Fatima Ali", time: "12:30 PM", type: "Follow-up", status: "confirmed" },
  { id: 5, name: "Usman Malik", time: "02:00 PM", type: "Consultation", status: "pending" },
];

const recentPatients = [
  { id: 1, name: "Ahmed Raza", age: 34, condition: "Hypertension", lastVisit: "Today", avatar: "AR" },
  { id: 2, name: "Sara Khan", age: 28, condition: "Diabetes Type 2", lastVisit: "Yesterday", avatar: "SK" },
  { id: 3, name: "Bilal Tariq", age: 45, condition: "Cardiac Review", lastVisit: "2 days ago", avatar: "BT" },
  { id: 4, name: "Fatima Ali", age: 52, condition: "Arthritis", lastVisit: "3 days ago", avatar: "FA" },
];
        ...
        <div className="px-5 py-4" style={{ borderBottom: "1px solid rgba(16,184,169,0.08)" }}>
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs truncate" style={{ color: "#10B8A9" }}>{doctor?.specialization || "Specialist"}</p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            >
              <div className="space-y-1.5">
                <span className="block w-5 h-0.5" style={{ background: "#10B8A9" }}></span>
                <span className="block w-5 h-0.5" style={{ background: "#10B8A9" }}></span>
                <span className="block w-5 h-0.5" style={{ background: "#10B8A9" }}></span>
              </div>
            </button>
            <div>
              ...
              <p className="text-xs hidden sm:block" style={{ color: "#64748b" }}>{today}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button className="relative p-2 rounded-xl transition-colors hover:bg-white hover:bg-opacity-5" style={{ color: "#64748b" }}>
              🔔
              <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full" style={{ background: "#10B8A9" }}></span>
            </button>
          ...
          {activeNav === "dashboard" && (
            <>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
                {[
                  { label: "Today's Patients", value: "12", sub: "+2 from yesterday", icon: "👥", color: "#10B8A9" },
                  { label: "Appointments", value: "8", sub: "3 pending", icon: "📅", color: "#38bdf8" },
                  { label: "Today's Earnings", value: "PKR 8,400", sub: "6 consultations", icon: "💰", color: "#22c55e" },
                  { label: "Prescriptions", value: "10", sub: "All sent via WhatsApp", icon: "📋", color: "#a78bfa" },
                ].map((stat) => (
                  <div
                    key={stat.label}
                ...
                >
                  <div className="flex items-center justify-between mb-5">
                    <div>
                      ...
                      <p className="text-xs" style={{ color: "#64748b" }}>Year 2026 overview</p>
                    </div>
                    ...
                    {upcomingAppointments.map((apt) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs" style={{ color: "#64748b" }}>{apt.time} · {apt.type}</p>
                        </div>
                        <span
              ...
              >
                <div className="flex items-center justify-between mb-5">
                  <div>
                    ...
                    <p className="text-xs" style={{ color: "#64748b" }}>Last visited patients</p>
                  </div>
                  <button className="text-xs font-semibold transition-colors hover:text-teal-300" style={{ color: "#10B8A9" }}>
                    View All →
                  </button>
                </div>
                    ...
                    >
                      <div className="sm:hidden flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs" style={{ color: "#64748b" }}>{patient.condition} · Age {patient.age}</p>
                        </div>
                        <span className="text-xs" style={{ color: "#10B8A9" }}>{patient.lastVisit}</span>
                      </div>
                      <div className="hidden sm:grid grid-cols-4 gap-4 items-center">
                        ...
                        <span className="text-sm" style={{ color: "#94a3b8" }}>{patient.age} yrs</span>
                        <span className="text-sm" style={{ color: "#94a3b8" }}>{patient.condition}</span>
                        <span className="text-sm font-medium" style={{ color: "#10B8A9" }}>{patient.lastVisit}</span>
                      </div>
                    </div>
                  ))}
                </div>
