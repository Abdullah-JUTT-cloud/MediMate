      ...
      <main className="px-4 pb-20 pt-32 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-[var(--color-text-secondary)]">
            MediMate was created to help doctors and clinic teams replace fragmented manual processes with a reliable digital workflow
          ...
          <div className="mt-12 space-y-6">
            <section className="rounded-2xl border bg-[var(--color-card)] p-6 sm:p-8">
              <h2 className="text-2xl font-bold">Why MediMate exists</h2>
            ...
            <section className="rounded-2xl border bg-[var(--color-card)] p-6 sm:p-8">
              ...
              <p className="mt-4 leading-relaxed text-[var(--color-text-secondary)]">
                MediMate is built for independent doctors, specialists, and clinic operators who need a practical platform that improves
            ...
            <section className="rounded-2xl border bg-[var(--color-card)] p-6 sm:p-8">
              ...
              <p className="mt-4 leading-relaxed text-[var(--color-text-secondary)]">
                We continue to improve MediMate with direct input from doctors and clinic staff, ensuring every release solves a real operational problem and preserves a fast, easy-to-use experience.
              </p>
            </section>
          </div>
        </div>
