...
const footerLinks = {
  ...
  Company: [{ name: "About Us", href: "/about-us" }],
  Support: [
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-4">
            ...
            <p className="mt-6 max-w-sm text-sm leading-relaxed text-[var(--color-text-secondary)]">
              Trusted clinic management for doctors who want fast workflows,
              secure delivery, and clear communication across every patient
              touchpoint.
            </p>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category} className="lg:col-span-2">
              <h4 className="font-heading text-sm font-semibold uppercase tracking-[0.22em] text-[var(--color-text-primary)]">
                {category}
              </h4>
          ...
          <div className="lg:col-span-4">
            <div className="rounded-4xl border border-[var(--color-border)]/70 bg-[var(--color-card)] p-6 shadow-[0_4px_20px_-2px_rgba(93,112,82,0.12)]">
              ...
              <p className="mt-3 text-sm leading-relaxed text-[var(--color-text-secondary)]">
                Get releases, clinic workflows, and feature updates that reduce
                friction without adding noise.
              </p>
        ...
        <div className="mt-14 border-t border-[var(--color-border)]/70 pt-6">
          <div className="flex flex-col gap-4 text-sm text-[var(--color-text-secondary)] lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap gap-5">
              <Link
                to="/privacy-policy"
                className="font-mono text-[10px] uppercase tracking-[0.24em] transition duration-300 hover:text-[var(--color-primary)]"
              >
                Privacy Policy
              </Link>
              <Link
