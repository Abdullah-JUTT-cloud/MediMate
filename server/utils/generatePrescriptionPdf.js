  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fillColor(teal)
        .text(`${doctor.title || "Dr."} ${doctor.fullName}`, 50, 50, {
          width: 280,
        });
      ...
      doc
        .fontSize(9)
        .fillColor(lightGray)
        .text(degrees, 50, 94, { width: 280 });
      doc
        .fontSize(9)
        .fillColor(lightGray)
        .text(`PMDC Reg. No: ${doctor.pmdcNumber || "N/A"}`, 50, 108, {
          width: 280,
        });
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fillColor(teal)
        .text("MedAlerto", 330, 50, { width: 215, align: "right" });
      ...
      // Box background
      doc.rect(50, patientBoxY, W, patientBoxH).fillColor(tealBg).fill();
      doc
        .rect(50, patientBoxY, W, patientBoxH)
        .lineWidth(0.5)
        .strokeColor(teal)
        .stroke();
      ...
      medicines.forEach((med, i) => {
        ...
        doc
          .font("Helvetica-Bold")
          .fillColor(dark)
          .text(med.name, tcols.name.x + 4, rowY + 9, {
            width: tcols.name.w - 8,
          });

        doc.font("Helvetica").fillColor(gray);
        doc.text(med.dosage, tcols.dose.x + 4, rowY + 9, {
          width: tcols.dose.w - 8,
        });
        doc.text(med.frequency, tcols.freq.x + 4, rowY + 9, {
          width: tcols.freq.w - 8,
        });
        doc.text(med.duration, tcols.dur.x + 4, rowY + 9, {
          width: tcols.dur.w - 8,
        });
        doc.text(med.instructions || "—", tcols.instr.x + 4, rowY + 9, {
      ...
      if (labTests.length) {
        ...
        labTests.forEach((testName, i) => {
          ...
          const textHeight = doc
            .font("Helvetica")
            .fontSize(9.5)
            .heightOfString(testName, { width: W - 42 });
          const rowHeight = Math.max(24, textHeight + 14);

          doc
            .rect(50, currentY, W, rowHeight)
            .fillColor(i % 2 === 0 ? "#f8fafc" : "#f1f5f9")
            .fill();
          ...
          doc
            ...
            .font("Helvetica-Bold")
            .fillColor(teal)
            .text(label, 60, currentY + 8, { width: 16 });

          doc
            .fontSize(9.5)
            .font("Helvetica")
            .fillColor(dark)
            .text(testName, 78, currentY + 8, {
              width: W - 42,
              lineGap: 1,
            });
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .fillColor(dark)
        .text(`${doctor.title || "Dr."} ${doctor.fullName}`, sigX, sigY + 7, {
          width: 195,
          align: "center",
        });
      ...
      doc
        ...
        .font("Helvetica")
        .fillColor(gray)
        .text(doctor.specialization || "", sigX, sigY + 22, {
          width: 195,
          align: "center",
        });
      ...
      doc
        .fontSize(8)
        .fillColor(lightGray)
        .text(`PMDC: ${doctor.pmdcNumber || "N/A"}`, sigX, sigY + 36, {
          width: 195,
          align: "center",
        });
      ...
      //   .text("Generated by MedAlerto — Smart Clinic Management System", 50, 808, { width: 300 });
